                        ...
                        if (!modal) {
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="container">
                                        ...
                                        <div class="col col-xl-6 col-12 Dark__container">
                                        <label class="Dark__label" for="segundo_name">Segundo Nombre (Opcional)</label>
                                    ...
                                    <div class="col col-xl-6 col-12  Dark__container">
                                    <label class="Dark__label" for="segundo_apellido">Segundo Apellido (Opcional)</label>
                            ...
                            <div class="col col-xl-6 col-12  Dark__containerSelect">
                                ...
                                <select id="estado" class="form-select Dark__select">
                                    ...
                                    <option value="No ausente">No ausente</option>
                                </select>
                        </div>
...
function guardarCambiosMedico(idMedico) {
    ...
    const camposObligatorios = ["numero_documento", "primer_name", "primer_apellido", "telefono", "correo"];
    let faltanCamposObligatorios = false;

    // Verificar si hay campos obligatorios vacíos
    camposObligatorios.forEach(campo => {
        if (!document.getElementById(campo).value.trim()) {
            faltanCamposObligatorios = true;
            mostrarIconoAdvertencia(campo);
        }
    });
...
function mostrarIconoAdvertencia(idCampo) {
    // Remover iconos de advertencia anteriores
    let iconoActual = document.getElementById(idCampo + "-warning");
    if (iconoActual) {
        iconoActual.remove();
    }

    // Crear y adjuntar el icono de advertencia
    ...
    icono.style.color = "red"; // Color rojo para icono de advertencia
    icono.id = idCampo + "-warning";
    campo.insertAdjacentElement("afterend", icono);
}
